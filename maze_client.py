...
parser = argparse.ArgumentParser(description='Creates an NxN maze using recursive splitting algorithm.')
parser.add_argument('-b', default=0, type=int,   help="maze building algorithm")
...
if args.b in [0,1]: m = maze.Maze(N=args.n, walls=False)
